...
public class MainActivity extends AppCompatActivity {
    ...
    interface PixabayAPI {
        ...
        Call<Response> search(@Tag String tag, @Query("q") String q, @Query("key") String key, @Query("image_type") String image_type);
...
/*
        ...
        Call<Response> call = api.search("search", "flowers", key, image_type);
